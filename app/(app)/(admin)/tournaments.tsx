...
export default function AdminTournamentsScreen() {
  ...
  const { data, isLoading, refetch } = useGetTournamentsQuery();
  const [createTournament, { isLoading: creating }] =
    useCreateTournamentMutation();
  const [updateTournament, { isLoading: updating }] =
    useUpdateTournamentMutation();
  const [deleteTournament, { isLoading: deleting }] =
    useDeleteTournamentMutation();
  ...
  const [deletingItem, setDeletingItem] = useState<Tournament | null>(null);
  ...
  const confirmDelete = async () => {
    ...
    try {
      await deleteTournament(deletingItem.id).unwrap();
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            <TouchableOpacity
              ...
              onPress={submit}
              disabled={creating || updating || !name || !startDate || !endDate}
            >
        ...
        <View style={styles.deleteModalBackdrop}>
          <View style={styles.deleteModalCard}>
            <View style={styles.deleteModalContent}>
              ...
              <Text style={styles.deleteModalTitle}>Delete Tournament</Text>
